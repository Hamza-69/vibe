...
const FragmentCard = ({isActiveFragment, onFragmentClick, fragment} : FragmenCardProps) =>{
  return (
    <button className={cn(
...
const AssistantMessage = ({content, fragment, createdAt, isActiveFragment, onFragmentClick, type} : AssistantMessage) => {
  return (
    <div className={cn(
      ...
      <div className="pl-8.5 flex flex-col gap-y-4">
        <span>{content.replaceAll("<task_summary>", "").replaceAll("</task_summary>", "")}</span>
